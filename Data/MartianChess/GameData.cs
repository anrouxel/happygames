namespace happygames.Data.MartianChess
{
    public class GameData
    {
        ...
        public GameData(int nswg, int mnswg, CoordinateData originCoordinate, CoordinateData destinationCoordinate, PlayerData?[] players, PlayerData? currentPlayer, BoardData board, bool isDisplace)
        {
            this.nswg = nswg;
            this.mnswg = mnswg;
